...
- **문항(세트당 3개)**: Hair Realism / Structure Fidelity(=Sketch Structure Fidelity) / Color Fidelity
...
![1. GT - CM_1121 - unbraid](../outputs/0824/user_study/gt/grid/CM_1121.png)

#### 2. COLOR · unbraid · CM_1028
- 정답 키: A=Sketch-only, B=Ours, C=VividHair, D=SHS, E=HairCLIPv2

![2. COLOR - CM_1028 - unbraid](../outputs/0824/user_study/color/grid/CM_1028.png)

#### 3. GT · braid · braid_2548
- 정답 키: A=HairCLIPv2, B=SHS, C=Ours, D=VividHair, E=Sketch-only

![3. GT - braid_2548 - braid](../outputs/0824/user_study/gt/grid/braid_2548.png)

#### 4. COLOR · unbraid · CM_1055
- 정답 키: A=Sketch-only, B=SHS, C=HairCLIPv2, D=VividHair, E=Ours

![4. COLOR - CM_1055 - unbraid](../outputs/0824/user_study/color/grid/CM_1055.png)

#### 5. COLOR · braid · braid_2562_1_2
- 정답 키: A=Sketch-only, B=HairCLIPv2, C=VividHair, D=SHS, E=Ours

![5. COLOR - braid_2562_1_2 - braid](../outputs/0824/user_study/color/grid/braid_2562_1_2.png)

#### 6. GT · braid · braid_3276
- 정답 키: A=Sketch-only, B=HairCLIPv2, C=VividHair, D=SHS, E=Ours

![6. GT - braid_3276 - braid](../outputs/0824/user_study/gt/grid/braid_3276.png)

#### 7. COLOR · unbraid · CM_1133
- 정답 키: A=SHS, B=VividHair, C=Sketch-only, D=Ours, E=HairCLIPv2

![7. COLOR - CM_1133 - unbraid](../outputs/0824/user_study/color/grid/CM_1133.png)

#### 8. GT · braid · CM_1067_12
- 정답 키: A=Ours, B=HairCLIPv2, C=SHS, D=VividHair, E=Sketch-only

![8. GT - CM_1067_12 - braid](../outputs/0824/user_study/gt/grid/CM_1067_12.png)

#### 9. COLOR · braid · braid_4276
- 정답 키: A=VividHair, B=HairCLIPv2, C=Ours, D=SHS, E=Sketch-only

![9. COLOR - braid_4276 - braid](../outputs/0824/user_study/color/grid/braid_4276.png)

#### 10. COLOR · braid · braid_4212
- 정답 키: A=VividHair, B=HairCLIPv2, C=Sketch-only, D=SHS, E=Ours

![10. COLOR - braid_4212 - braid](../outputs/0824/user_study/color/grid/braid_4212.png)

#### 11. COLOR · unbraid · CM_1215
- 정답 키: A=SHS, B=HairCLIPv2, C=VividHair, D=Sketch-only, E=Ours

![11. COLOR - CM_1215 - unbraid](../outputs/0824/user_study/color/grid/CM_1215.png)

#### 12. GT · unbraid · CM_1027
- 정답 키: A=HairCLIPv2, B=VividHair, C=Ours, D=Sketch-only, E=SHS

![12. GT - CM_1027 - unbraid](../outputs/0824/user_study/gt/grid/CM_1027.png)

#### 13. GT · unbraid · CM_1151
- 정답 키: A=Ours, B=HairCLIPv2, C=SHS, D=VividHair, E=Sketch-only

![13. GT - CM_1151 - unbraid](../outputs/0824/user_study/gt/grid/CM_1151.png)

#### 14. COLOR · unbraid · CM_1139
- 정답 키: A=VividHair, B=Ours, C=Sketch-only, D=HairCLIPv2, E=SHS

![14. COLOR - CM_1139 - unbraid](../outputs/0824/user_study/color/grid/CM_1139.png)

#### 15. GT · braid · wavy_753
- 정답 키: A=Sketch-only, B=HairCLIPv2, C=Ours, D=SHS, E=VividHair

![15. GT - wavy_753 - braid](../outputs/0824/user_study/gt/grid/wavy_753.png)

#### 16. GT · unbraid · CM1033
- 정답 키: A=VividHair, B=HairCLIPv2, C=SHS, D=Ours, E=Sketch-only

![16. GT - CM1033 - unbraid](../outputs/0824/user_study/gt/grid/CM_1033.png)

#### 17. COLOR · braid · braid_4156
- 정답 키: A=Ours, B=Sketch-only, C=VividHair, D=SHS, E=HairCLIPv2

![17. COLOR - braid_4156 - braid](../outputs/0824/user_study/color/grid/braid_4156.png)

#### 18. GT · unbraid · CM_1009
- 정답 키: A=Ours, B=HairCLIPv2, C=VividHair, D=SHS, E=Sketch-only

![18. GT - CM_1009 - unbraid](../outputs/0824/user_study/gt/grid/CM_1009.png)

#### 19. COLOR · unbraid · CM_1007
- 정답 키: A=Ours, B=VividHair, C=SHS, D=Sketch-only, E=HairCLIPv2

![19. COLOR - CM_1007 - unbraid](../outputs/0824/user_study/color/grid/CM_1007.png)

#### 20. GT · braid · wavy_749
- 정답 키: A=Ours, B=HairCLIPv2, C=Sketch-only, D=VividHair, E=SHS

![20. GT - wavy_749 - braid](../outputs/0824/user_study/gt/grid/wavy_749.png)
